...
#' }
#'
asap_random_bulk_mtx <- function(mtx_file, row_file, col_file, idx_file, num_factors, r_covar_n = NULL, r_covar_d = NULL, rows_restrict = NULL, rseed = 42L, verbose = FALSE, NUM_THREADS = 0L, CELL_NORM = 1e4, BLOCK_SIZE = 1000L, do_log1p = FALSE, do_down_sample = FALSE, save_aux_data = FALSE, weighted_rand_proj = FALSE, CELL_PER_SAMPLE = 100L, a0 = 1e-8, b0 = 1, MAX_ROW_WORD = 2L, ROW_WORD_SEP = '_', MAX_COL_WORD = 100L, COL_WORD_SEP = '@') {
    .Call('_asapR_asap_random_bulk_mtx', PACKAGE = 'asapR', mtx_file, row_file, col_file, idx_file, num_factors, r_covar_n, r_covar_d, rows_restrict, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_log1p, do_down_sample, save_aux_data, weighted_rand_proj, CELL_PER_SAMPLE, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP)
}
...
#' }
#'
asap_random_bulk_cbind <- function(y_dn_vec, num_factors, row_names = NULL, control_features = NULL, batch_names = NULL, rseed = 42L, verbose = TRUE, NUM_THREADS = 0L, CELL_NORM = 1e4, BLOCK_SIZE = 1000L, do_batch_adj = TRUE, do_log1p = FALSE, do_down_sample = TRUE, save_aux_data = FALSE, KNN_CELL = 10L, CELL_PER_SAMPLE = 100L, BATCH_ADJ_ITER = 100L, MIN_CONTROL_ROWS = 10L, a0 = 1, b0 = 1) {
    .Call('_asapR_asap_random_bulk_cbind', PACKAGE = 'asapR', y_dn_vec, num_factors, row_names, control_features, batch_names, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_batch_adj, do_log1p, do_down_sample, save_aux_data, KNN_CELL, CELL_PER_SAMPLE, BATCH_ADJ_ITER, MIN_CONTROL_ROWS, a0, b0)
}
...
#' }
#'
asap_random_bulk_cbind_mtx <- function(mtx_files, row_files, col_files, idx_files, num_factors, batch_names = NULL, rows_restrict = NULL, control_features = NULL, rename_columns = TRUE, take_union_rows = FALSE, rseed = 42L, verbose = TRUE, NUM_THREADS = 0L, CELL_NORM = 1e4, BLOCK_SIZE = 1000L, do_batch_adj = TRUE, do_log1p = FALSE, do_down_sample = TRUE, save_aux_data = FALSE, KNN_CELL = 10L, CELL_PER_SAMPLE = 100L, BATCH_ADJ_ITER = 100L, MIN_CONTROL_ROWS = 10L, a0 = 1, b0 = 1, MAX_ROW_WORD = 2L, ROW_WORD_SEP = '_', MAX_COL_WORD = 100L, COL_WORD_SEP = '@') {
    .Call('_asapR_asap_random_bulk_cbind_mtx', PACKAGE = 'asapR', mtx_files, row_files, col_files, idx_files, num_factors, batch_names, rows_restrict, control_features, rename_columns, take_union_rows, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_batch_adj, do_log1p, do_down_sample, save_aux_data, KNN_CELL, CELL_PER_SAMPLE, BATCH_ADJ_ITER, MIN_CONTROL_ROWS, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP)
}
...
#'
#'
asap_random_bulk_interacting_columns <- function(mtx_file, row_file, col_file, idx_file, num_factors, W_nm_list, mtx_file_rhs = NULL, row_file_rhs = NULL, col_file_rhs = NULL, idx_file_rhs = NULL, A_dd_list = NULL, rseed = 42L, do_product = FALSE, do_log1p = FALSE, do_down_sample = FALSE, save_rand_proj = FALSE, weighted_rand_proj = FALSE, NUM_THREADS = 0L, CELL_NORM = 1e4, BLOCK_SIZE = 1000L, EDGE_PER_SAMPLE = 100L, a0 = 1, b0 = 1, MAX_ROW_WORD = 2L, ROW_WORD_SEP = '_', MAX_COL_WORD = 100L, COL_WORD_SEP = '@', verbose = FALSE) {
    .Call('_asapR_asap_random_bulk_interacting_columns', PACKAGE = 'asapR', mtx_file, row_file, col_file, idx_file, num_factors, W_nm_list, mtx_file_rhs, row_file_rhs, col_file_rhs, idx_file_rhs, A_dd_list, rseed, do_product, do_log1p, do_down_sample, save_rand_proj, weighted_rand_proj, NUM_THREADS, CELL_NORM, BLOCK_SIZE, EDGE_PER_SAMPLE, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP, verbose)
}
...
#' }
#'
asap_random_bulk_linking_mtx <- function(mtx_files, row_files, col_files, idx_files, num_factors, rseed = 42L, verbose = TRUE, NUM_THREADS = 1L, CELL_NORM = 1e4, BLOCK_SIZE = 1000L, do_log1p = FALSE, do_down_sample = FALSE, save_rand_proj = FALSE, weighted_rand_proj = FALSE, CELL_PER_SAMPLE = 100L, a0 = 1e-8, b0 = 1, MAX_ROW_WORD = 2L, ROW_WORD_SEP = '_', MAX_COL_WORD = 100L, COL_WORD_SEP = '@') {
    .Call('_asapR_asap_random_bulk_linking_mtx', PACKAGE = 'asapR', mtx_files, row_files, col_files, idx_files, num_factors, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_log1p, do_down_sample, save_rand_proj, weighted_rand_proj, CELL_PER_SAMPLE, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP)
}
...
#'
#'
asap_fit_pmf <- function(Y_, maxK, max_iter = 100L, verbose = TRUE, a0 = 1, b0 = 1, do_log1p = FALSE, rseed = 1337L, svd_init = FALSE, do_degree_correction = FALSE, normalize_cols = FALSE, EPS = 1e-8, jitter = 1.0, NUM_THREADS = 0L) {
    .Call('_asapR_asap_fit_pmf', PACKAGE = 'asapR', Y_, maxK, max_iter, verbose, a0, b0, do_log1p, rseed, svd_init, do_degree_correction, normalize_cols, EPS, jitter, NUM_THREADS)
}
...
#'
#'
asap_fit_pmf_delta <- function(y_ref, y_dn_vec, maxK, max_iter = 100L, verbose = TRUE, a0 = 1, b0 = 1, do_log1p = FALSE, rseed = 1337L, svd_init = FALSE, do_degree_correction = FALSE, normalize_cols = FALSE, EPS = 1e-8, jitter = 1.0, NUM_THREADS = 0L) {
    .Call('_asapR_asap_fit_pmf_delta', PACKAGE = 'asapR', y_ref, y_dn_vec, maxK, max_iter, verbose, a0, b0, do_log1p, rseed, svd_init, do_degree_correction, normalize_cols, EPS, jitter, NUM_THREADS)
}
...
#'
#'
asap_fit_pmf_larch <- function(Y_, max_depth, max_iter = 100L, verbose = TRUE, a0 = 1, b0 = 1, do_log1p = FALSE, rseed = 1337L, svd_init = FALSE, do_degree_correction = FALSE, normalize_cols = FALSE, EPS = 1e-8, jitter = 1.0, NUM_THREADS = 0L) {
    .Call('_asapR_asap_fit_pmf_larch', PACKAGE = 'asapR', Y_, max_depth, max_iter, verbose, a0, b0, do_log1p, rseed, svd_init, do_degree_correction, normalize_cols, EPS, jitter, NUM_THREADS)
}
