...
pheatmap(.out0$log.beta[gg, ], Rowv=NA, Colv=NA, scale = "row", main = "beta")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out0$theta[kk, ], Rowv=NA, Colv=NA, scale = "row", main = "theta1")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out0$theta[kk + n, ], Rowv=NA, Colv=NA, scale = "row", main = "theta2")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out0$theta[kk + 2*n, ], Rowv=NA, Colv=NA, scale = "row", main = "theta3")
```
...
```{r fig.width=5, fig.height=4}
pheatmap(.out$beta[gg,], Rowv=NA, Colv=NA, scale = "row", main = "beta")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out$theta.list[[1]][kk,], Rowv=NA, Colv=NA, scale = "row", main = "theta1 (1 + 2)")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out$theta.list[[2]][kk,], Rowv=NA, Colv=NA, scale = "row", main = "theta2 (3 + 4)")
```

```{r fig.width=5, fig.height=4}
pheatmap(.out$theta.list[[3]][kk,], Rowv=NA, Colv=NA, scale = "row", main = "theta3 (4 + 5)")
```
