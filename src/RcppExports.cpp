...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type MAX_COL_WORD(MAX_COL_WORDSEXP);
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_random_bulk_multi(mtx_files, row_files, col_files, idx_files, num_factors, take_union_rows, rseed, verbose, NUM_THREADS, BLOCK_SIZE, do_batch_adj, do_log1p, do_down_sample, save_rand_proj, KNN_CELL, CELL_PER_SAMPLE, BATCH_ADJ_ITER, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP));
    return rcpp_result_gen;
END_RCPP
}
// asap_topic_pmf
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_asapR_asap_random_bulk_multi", (DL_FUNC) &_asapR_asap_random_bulk_multi, 23},
