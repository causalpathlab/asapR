...
Rcpp::List asap_build_interacting_columns(const Eigen::SparseMatrix<float>& y_dn, const Eigen::SparseMatrix<float>& z_dm, const Eigen::MatrixXf log_beta, const Rcpp::StringVector beta_row_names, const std::size_t knn, const bool do_stdize_beta, const bool do_log1p, const bool verbose, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE);
RcppExport SEXP _asapR_asap_build_interacting_columns(SEXP y_dnSEXP, SEXP z_dmSEXP, SEXP log_betaSEXP, SEXP beta_row_namesSEXP, SEXP knnSEXP, SEXP do_stdize_betaSEXP, SEXP do_log1pSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type BLOCK_SIZE(BLOCK_SIZESEXP);
    rcpp_result_gen = Rcpp::wrap(asap_build_interacting_columns(y_dn, z_dm, log_beta, beta_row_names, knn, do_stdize_beta, do_log1p, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE));
    return rcpp_result_gen;
END_RCPP
}
// asap_build_interaction_columns_mtx
Rcpp::List asap_build_interaction_columns_mtx(const std::string mtx_file, const std::string row_file, const std::string col_file, const std::string idx_file, const Eigen::MatrixXf log_beta, const Rcpp::StringVector beta_row_names, const std::size_t knn, const Rcpp::Nullable<std::string> mtx_file_rhs, const Rcpp::Nullable<std::string> row_file_rhs, const Rcpp::Nullable<std::string> col_file_rhs, const Rcpp::Nullable<std::string> idx_file_rhs, const bool do_stdize_beta, const bool do_log1p, const bool verbose, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE, const std::size_t MAX_ROW_WORD, const char ROW_WORD_SEP, const std::size_t MAX_COL_WORD, const char COL_WORD_SEP);
RcppExport SEXP _asapR_asap_build_interaction_columns_mtx(SEXP mtx_fileSEXP, SEXP row_fileSEXP, SEXP col_fileSEXP, SEXP idx_fileSEXP, SEXP log_betaSEXP, SEXP beta_row_namesSEXP, SEXP knnSEXP, SEXP mtx_file_rhsSEXP, SEXP row_file_rhsSEXP, SEXP col_file_rhsSEXP, SEXP idx_file_rhsSEXP, SEXP do_stdize_betaSEXP, SEXP do_log1pSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP, SEXP MAX_ROW_WORDSEXP, SEXP ROW_WORD_SEPSEXP, SEXP MAX_COL_WORDSEXP, SEXP COL_WORD_SEPSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(asap_build_interaction_columns_mtx(mtx_file, row_file, col_file, idx_file, log_beta, beta_row_names, knn, mtx_file_rhs, row_file_rhs, col_file_rhs, idx_file_rhs, do_stdize_beta, do_log1p, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::List asap_random_bulk_cbind(const std::vector<Eigen::SparseMatrix<float>> y_dn_vec, const std::size_t num_factors, const Rcpp::Nullable<Rcpp::StringVector> row_names, const Rcpp::Nullable<Rcpp::StringVector> control_features, const Rcpp::Nullable<Rcpp::StringVector> batch_names, const std::size_t rseed, const bool verbose, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE, const bool do_batch_adj, const bool do_log1p, const bool do_down_sample, const bool save_aux_data, const std::size_t KNN_CELL, const std::size_t CELL_PER_SAMPLE, const std::size_t BATCH_ADJ_ITER, const std::size_t MIN_CONTROL_ROWS, const double a0, const double b0);
RcppExport SEXP _asapR_asap_random_bulk_cbind(SEXP y_dn_vecSEXP, SEXP num_factorsSEXP, SEXP row_namesSEXP, SEXP control_featuresSEXP, SEXP batch_namesSEXP, SEXP rseedSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP, SEXP do_batch_adjSEXP, SEXP do_log1pSEXP, SEXP do_down_sampleSEXP, SEXP save_aux_dataSEXP, SEXP KNN_CELLSEXP, SEXP CELL_PER_SAMPLESEXP, SEXP BATCH_ADJ_ITERSEXP, SEXP MIN_CONTROL_ROWSSEXP, SEXP a0SEXP, SEXP b0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<Eigen::SparseMatrix<float>> >::type y_dn_vec(y_dn_vecSEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type num_factors(num_factorsSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::StringVector> >::type row_names(row_namesSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::StringVector> >::type control_features(control_featuresSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::StringVector> >::type batch_names(batch_namesSEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type rseed(rseedSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type NUM_THREADS(NUM_THREADSSEXP);
    Rcpp::traits::input_parameter< const double >::type CELL_NORM(CELL_NORMSEXP);
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type MIN_CONTROL_ROWS(MIN_CONTROL_ROWSSEXP);
    Rcpp::traits::input_parameter< const double >::type a0(a0SEXP);
    Rcpp::traits::input_parameter< const double >::type b0(b0SEXP);
    rcpp_result_gen = Rcpp::wrap(asap_random_bulk_cbind(y_dn_vec, num_factors, row_names, control_features, batch_names, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_batch_adj, do_log1p, do_down_sample, save_aux_data, KNN_CELL, CELL_PER_SAMPLE, BATCH_ADJ_ITER, MIN_CONTROL_ROWS, a0, b0));
    return rcpp_result_gen;
END_RCPP
}
// asap_random_bulk_cbind_mtx
Rcpp::List asap_random_bulk_cbind_mtx(const std::vector<std::string> mtx_files, const std::vector<std::string> row_files, const std::vector<std::string> col_files, const std::vector<std::string> idx_files, const std::size_t num_factors, const Rcpp::Nullable<Rcpp::StringVector> batch_names, const Rcpp::Nullable<Rcpp::StringVector> rows_restrict, const Rcpp::Nullable<Rcpp::StringVector> control_features, const bool rename_columns, const bool take_union_rows, const std::size_t rseed, const bool verbose, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE, const bool do_batch_adj, const bool do_log1p, const bool do_down_sample, const bool save_aux_data, const std::size_t KNN_CELL, const std::size_t CELL_PER_SAMPLE, const std::size_t BATCH_ADJ_ITER, const std::size_t MIN_CONTROL_ROWS, const double a0, const double b0, const std::size_t MAX_ROW_WORD, const char ROW_WORD_SEP, const std::size_t MAX_COL_WORD, const char COL_WORD_SEP);
RcppExport SEXP _asapR_asap_random_bulk_cbind_mtx(SEXP mtx_filesSEXP, SEXP row_filesSEXP, SEXP col_filesSEXP, SEXP idx_filesSEXP, SEXP num_factorsSEXP, SEXP batch_namesSEXP, SEXP rows_restrictSEXP, SEXP control_featuresSEXP, SEXP rename_columnsSEXP, SEXP take_union_rowsSEXP, SEXP rseedSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP, SEXP do_batch_adjSEXP, SEXP do_log1pSEXP, SEXP do_down_sampleSEXP, SEXP save_aux_dataSEXP, SEXP KNN_CELLSEXP, SEXP CELL_PER_SAMPLESEXP, SEXP BATCH_ADJ_ITERSEXP, SEXP MIN_CONTROL_ROWSSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP MAX_ROW_WORDSEXP, SEXP ROW_WORD_SEPSEXP, SEXP MAX_COL_WORDSEXP, SEXP COL_WORD_SEPSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_random_bulk_interacting_columns(mtx_file, row_file, col_file, idx_file, num_factors, W_nm_list, mtx_file_rhs, row_file_rhs, col_file_rhs, idx_file_rhs, A_dd_list, rseed, do_product, do_log1p, do_down_sample, save_rand_proj, weighted_rand_proj, NUM_THREADS, CELL_NORM, BLOCK_SIZE, EDGE_PER_SAMPLE, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP, verbose));
    return rcpp_result_gen;
END_RCPP
}
// asap_random_bulk_linking_mtx
Rcpp::List asap_random_bulk_linking_mtx(const std::vector<std::string> mtx_files, const std::vector<std::string> row_files, const std::vector<std::string> col_files, const std::vector<std::string> idx_files, const std::size_t num_factors, const std::size_t rseed, const bool verbose, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE, const bool do_log1p, const bool do_down_sample, const bool save_rand_proj, const bool weighted_rand_proj, const std::size_t CELL_PER_SAMPLE, const double a0, const double b0, const std::size_t MAX_ROW_WORD, const char ROW_WORD_SEP, const std::size_t MAX_COL_WORD, const char COL_WORD_SEP);
RcppExport SEXP _asapR_asap_random_bulk_linking_mtx(SEXP mtx_filesSEXP, SEXP row_filesSEXP, SEXP col_filesSEXP, SEXP idx_filesSEXP, SEXP num_factorsSEXP, SEXP rseedSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP, SEXP do_log1pSEXP, SEXP do_down_sampleSEXP, SEXP save_rand_projSEXP, SEXP weighted_rand_projSEXP, SEXP CELL_PER_SAMPLESEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP MAX_ROW_WORDSEXP, SEXP ROW_WORD_SEPSEXP, SEXP MAX_COL_WORDSEXP, SEXP COL_WORD_SEPSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<std::string> >::type mtx_files(mtx_filesSEXP);
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type MAX_COL_WORD(MAX_COL_WORDSEXP);
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_random_bulk_linking_mtx(mtx_files, row_files, col_files, idx_files, num_factors, rseed, verbose, NUM_THREADS, CELL_NORM, BLOCK_SIZE, do_log1p, do_down_sample, save_rand_proj, weighted_rand_proj, CELL_PER_SAMPLE, a0, b0, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP));
    return rcpp_result_gen;
END_RCPP
}
...
// asap_pmf_regression
Rcpp::List asap_pmf_regression(const Eigen::SparseMatrix<float>& y_dn, const Eigen::MatrixXf log_beta, const Rcpp::StringVector beta_row_names, const Rcpp::Nullable<Eigen::MatrixXf> log_delta, const bool do_stdize_beta, const bool do_stdize_r, const bool do_log1p, const double a0, const double b0, const std::size_t max_iter, const bool verbose, const std::size_t NUM_THREADS, const std::size_t BLOCK_SIZE);
RcppExport SEXP _asapR_asap_pmf_regression(SEXP y_dnSEXP, SEXP log_betaSEXP, SEXP beta_row_namesSEXP, SEXP log_deltaSEXP, SEXP do_stdize_betaSEXP, SEXP do_stdize_rSEXP, SEXP do_log1pSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP max_iterSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP BLOCK_SIZESEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::SparseMatrix<float>& >::type y_dn(y_dnSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type do_stdize_beta(do_stdize_betaSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_stdize_r(do_stdize_rSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_log1p(do_log1pSEXP);
    Rcpp::traits::input_parameter< const double >::type a0(a0SEXP);
    Rcpp::traits::input_parameter< const double >::type b0(b0SEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type max_iter(max_iterSEXP);
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type NUM_THREADS(NUM_THREADSSEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type BLOCK_SIZE(BLOCK_SIZESEXP);
    rcpp_result_gen = Rcpp::wrap(asap_pmf_regression(y_dn, log_beta, beta_row_names, log_delta, do_stdize_beta, do_stdize_r, do_log1p, a0, b0, max_iter, verbose, NUM_THREADS, BLOCK_SIZE));
    return rcpp_result_gen;
END_RCPP
}
// asap_pmf_regression_mtx
Rcpp::List asap_pmf_regression_mtx(const std::string mtx_file, const std::string row_file, const std::string col_file, const std::string idx_file, const Eigen::MatrixXf log_beta, const Rcpp::StringVector beta_row_names, const Rcpp::Nullable<Eigen::MatrixXf> log_delta, const bool do_stdize_beta, const bool do_stdize_r, const bool do_log1p, const double a0, const double b0, const std::size_t max_iter, const bool verbose, const std::size_t NUM_THREADS, const std::size_t BLOCK_SIZE, const std::size_t MAX_ROW_WORD, const char ROW_WORD_SEP, const std::size_t MAX_COL_WORD, const char COL_WORD_SEP);
RcppExport SEXP _asapR_asap_pmf_regression_mtx(SEXP mtx_fileSEXP, SEXP row_fileSEXP, SEXP col_fileSEXP, SEXP idx_fileSEXP, SEXP log_betaSEXP, SEXP beta_row_namesSEXP, SEXP log_deltaSEXP, SEXP do_stdize_betaSEXP, SEXP do_stdize_rSEXP, SEXP do_log1pSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP max_iterSEXP, SEXP verboseSEXP, SEXP NUM_THREADSSEXP, SEXP BLOCK_SIZESEXP, SEXP MAX_ROW_WORDSEXP, SEXP ROW_WORD_SEPSEXP, SEXP MAX_COL_WORDSEXP, SEXP COL_WORD_SEPSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type mtx_file(mtx_fileSEXP);
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type MAX_COL_WORD(MAX_COL_WORDSEXP);
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_pmf_regression_mtx(mtx_file, row_file, col_file, idx_file, log_beta, beta_row_names, log_delta, do_stdize_beta, do_stdize_r, do_log1p, a0, b0, max_iter, verbose, NUM_THREADS, BLOCK_SIZE, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP));
    return rcpp_result_gen;
END_RCPP
}
// asap_topic_pmf
Rcpp::List asap_topic_pmf(const Eigen::MatrixXf beta_dk, const Eigen::MatrixXf R_nk, const Eigen::MatrixXf Ysum_n, const double a0, const double b0, const std::size_t max_iter, const std::size_t NUM_THREADS, const bool do_stdize_r, const bool verbose);
RcppExport SEXP _asapR_asap_topic_pmf(SEXP beta_dkSEXP, SEXP R_nkSEXP, SEXP Ysum_nSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP max_iterSEXP, SEXP NUM_THREADSSEXP, SEXP do_stdize_rSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const Eigen::MatrixXf >::type Ysum_n(Ysum_nSEXP);
    Rcpp::traits::input_parameter< const double >::type a0(a0SEXP);
    Rcpp::traits::input_parameter< const double >::type b0(b0SEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type max_iter(max_iterSEXP);
    Rcpp::traits::input_parameter< const std::size_t >::type NUM_THREADS(NUM_THREADSSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Rcpp::StringVector >::type beta_row_names(beta_row_namesSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Eigen::MatrixXf> >::type log_delta(log_deltaSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Eigen::MatrixXf> >::type batch_names(batch_namesSEXP);
    Rcpp::traits::input_parameter< const bool >::type rename_columns(rename_columnsSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_stdize_beta(do_stdize_betaSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_stdize_r(do_stdize_rSEXP);
    Rcpp::traits::input_parameter< const bool >::type do_log1p(do_log1pSEXP);
    ...
    Rcpp::traits::input_parameter< const std::size_t >::type MAX_COL_WORD(MAX_COL_WORDSEXP);
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_pmf_regression_cbind_mtx(mtx_files, row_files, col_files, idx_files, log_beta, beta_row_names, log_delta, batch_names, rename_columns, do_stdize_beta, do_stdize_r, do_log1p, verbose, a0, b0, max_iter, NUM_THREADS, BLOCK_SIZE, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP));
    return rcpp_result_gen;
END_RCPP
}
// asap_pmf_stat_interacting_columns_mtx
Rcpp::List asap_pmf_stat_interacting_columns_mtx(const std::string mtx_file, const std::string row_file, const std::string col_file, const std::string idx_file, const Eigen::MatrixXf log_beta, const Rcpp::StringVector beta_row_names, const Rcpp::List W_nm_list, const Rcpp::Nullable<std::string> mtx_file2, const Rcpp::Nullable<std::string> row_file2, const Rcpp::Nullable<std::string> col_file2, const Rcpp::Nullable<std::string> idx_file2, const Rcpp::Nullable<Rcpp::List> A_dd_list, const bool do_stdize_beta, const bool do_product, const std::size_t NUM_THREADS, const double CELL_NORM, const std::size_t BLOCK_SIZE, const std::size_t MAX_ROW_WORD, const char ROW_WORD_SEP, const std::size_t MAX_COL_WORD, const char COL_WORD_SEP, const bool verbose);
RcppExport SEXP _asapR_asap_pmf_stat_interacting_columns_mtx(SEXP mtx_fileSEXP, SEXP row_fileSEXP, SEXP col_fileSEXP, SEXP idx_fileSEXP, SEXP log_betaSEXP, SEXP beta_row_namesSEXP, SEXP W_nm_listSEXP, SEXP mtx_file2SEXP, SEXP row_file2SEXP, SEXP col_file2SEXP, SEXP idx_file2SEXP, SEXP A_dd_listSEXP, SEXP do_stdize_betaSEXP, SEXP do_productSEXP, SEXP NUM_THREADSSEXP, SEXP CELL_NORMSEXP, SEXP BLOCK_SIZESEXP, SEXP MAX_ROW_WORDSEXP, SEXP ROW_WORD_SEPSEXP, SEXP MAX_COL_WORDSEXP, SEXP COL_WORD_SEPSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string >::type mtx_file(mtx_fileSEXP);
    ...
    Rcpp::traits::input_parameter< const char >::type COL_WORD_SEP(COL_WORD_SEPSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_pmf_stat_interacting_columns_mtx(mtx_file, row_file, col_file, idx_file, log_beta, beta_row_names, W_nm_list, mtx_file2, row_file2, col_file2, idx_file2, A_dd_list, do_stdize_beta, do_product, NUM_THREADS, CELL_NORM, BLOCK_SIZE, MAX_ROW_WORD, ROW_WORD_SEP, MAX_COL_WORD, COL_WORD_SEP, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::NumericMatrix asap_stretch_nn_matrix_columns(const Eigen::MatrixXf Y, const double qq_min, const double qq_max, const double std_min, const double std_max, const bool verbose);
RcppExport SEXP _asapR_asap_stretch_nn_matrix_columns(SEXP YSEXP, SEXP qq_minSEXP, SEXP qq_maxSEXP, SEXP std_minSEXP, SEXP std_maxSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(asap_stretch_nn_matrix_columns(Y, qq_min, qq_max, std_min, std_max, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_asapR_asap_build_interacting_columns", (DL_FUNC) &_asapR_asap_build_interacting_columns, 11},
    {"_asapR_asap_build_interaction_columns_mtx", (DL_FUNC) &_asapR_asap_build_interaction_columns_mtx, 21},
    {"_asapR_asap_random_bulk_mtx", (DL_FUNC) &_asapR_asap_random_bulk_mtx, 24},
    {"_asapR_asap_random_bulk_cbind", (DL_FUNC) &_asapR_asap_random_bulk_cbind, 20},
    {"_asapR_asap_random_bulk_cbind_mtx", (DL_FUNC) &_asapR_asap_random_bulk_cbind_mtx, 29},
    {"_asapR_asap_random_bulk_interacting_columns", (DL_FUNC) &_asapR_asap_random_bulk_interacting_columns, 28},
    {"_asapR_asap_random_bulk_linking_mtx", (DL_FUNC) &_asapR_asap_random_bulk_linking_mtx, 21},
    ...
    {"_asapR_asap_stretch_nn_matrix_columns", (DL_FUNC) &_asapR_asap_stretch_nn_matrix_columns, 6},
